...
Public Class DecimalExpandable
    ...
    Public Overrides Function ToString() As String
        If MinimumValue <> Nothing And MaximumValue = Nothing Then
            Return String.Format("A partir de {0}", FormatNumber(MinimumValue, 2, TriState.True))
        ElseIf MinimumValue <> Nothing And MaximumValue <> Nothing Then
            Return String.Format("De {0} a {1}", FormatNumber(MinimumValue, 2, TriState.True), FormatNumber(MaximumValue, 2, TriState.True))
        ElseIf MinimumValue = Nothing And MaximumValue <> Nothing Then
            Return String.Format("Até {0}", FormatNumber(MaximumValue, 2, TriState.True))
        End If
        Return Nothing
    End Function
    Public Sub New()
