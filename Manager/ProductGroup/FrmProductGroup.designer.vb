...
Partial Class FrmProductGroup
    ...
    Private Sub InitializeComponent()
        ...
        Me.BtnInclude.Text = "Incluir Grupo de Produto"
        '
        'BtnDelete
        '
        ...
        Me.BtnDelete.Text = "Excluir Grupo de Produto"
        '
        'BtnFirst
        '
        ...
        Me.BtnFirst.Text = "Primeiro Grupo de Produto"
        '
        'BtnPrevious
        '
        ...
        Me.BtnPrevious.Text = "Grupo de Produto Anterior"
        '
        'BtnNext
        '
        ...
        Me.BtnNext.Text = "Próximo Grupo de Produto"
        '
        'BtnLast
        '
        ...
        Me.BtnLast.Text = "Último Grupo de Produto"
        '
        'BtnLog
        '
