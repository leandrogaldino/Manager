...
Partial Class FrmCrms
    ...
    Private Sub InitializeComponent()
        ...
        'TcDetail
        '
        Me.TcDetail.Controls.Add(Me.TabTreatment)
    ...
    Friend WithEvents TabTreatment As TabPage
    Friend WithEvents BtnExport As ToolStripButton
    Friend WithEvents DgvCrmLayout As DataGridViewLayout
