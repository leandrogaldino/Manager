...
Public Class CompressorFilter
    ...
    Public Property Manufacturer As New PersonExpandable
    ...
    Public Overridable Function Filter() As Boolean
        ...
        Using Con As New MySqlConnection(Session.Setting.Database.GetConnectionString())
            ...
            Using Cmd As New MySqlCommand(My.Resources.CompressorFilter, Con)
                ...
                If Manufacturer.Name <> Nothing Then Cmd.Parameters.AddWithValue("@manufacturername", Manufacturer.Name) : Filtering = True Else Cmd.Parameters.AddWithValue("@manufacturername", "%")
    ...
    Public Sub Clean()
        ...
        Name = Nothing
        Status = Nothing
        Manufacturer = New PersonExpandable
    End Sub
End Class
