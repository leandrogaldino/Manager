...
Public Class FrmCompressorSellableWorkedHour
    ...
    '    _Loading = True
    '    LblOrderValue.Text = If(_PartWorkedHour.IsSaved, _CompressorForm.DgvCompressorSellableWorkedHour.SelectedRows(0).Cells("Order").Value, 0)
    ...
    '        _PartWorkedHour = _Compressor.WorkedHourSellables.Value.Single(Function(x) x.Guid = _CompressorForm.DgvCompressorSellableWorkedHour.SelectedRows(0).Cells("Guid").Value)
    '        LoadForm()
    ...
    '        End If
    '        _CompressorForm.DgvCompressorSellableWorkedHour.Fill(_Compressor.WorkedHourSellables.Value)
    ...
    '            BtnDelete.Enabled = True
    '        End If
    '        Row = _CompressorForm.DgvCompressorSellableWorkedHour.Rows.Cast(Of DataGridViewRow).FirstOrDefault(Function(x) x.Cells("Guid").Value = _PartWorkedHour.Guid)
