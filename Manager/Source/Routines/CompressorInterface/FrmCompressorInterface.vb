...
Public Class FrmCompressorInterface
    ...
    End Sub
    Private Sub TxtTextChanged(sender As Object, e As EventArgs) Handles TxtName.TextChanged, CbxDirection.SelectedIndexChanged, QbxProduct.TextChanged
        EprValidation.Clear()
    ...
    Private Function IsValidFields() As Boolean
        If String.IsNullOrWhiteSpace(TxtName.Text) Then
            ...
            TxtName.Select()
            Return False
        ElseIf Not String.IsNullOrWhiteSpace(QbxProduct.Text) AndAlso Not QbxProduct.IsFreezed Then
