...
Public Class UcCompressorInterfaceGrid
    Private _Interface As New CompressorInterface
    ...
    Private Sub BtnEdit_Click(sender As Object, e As EventArgs) Handles BtnEdit.Click
        If DgvData.SelectedRows.Count = 1 Then
            Try
                ...
                _Interface = New CompressorInterface().Load(DgvData.SelectedRows(0).Cells("id").Value, True)
                Using Form As New FrmCompressorInterface(_Interface, Me)
                    Form.ShowDialog()
                End Using
    ...
    Private Sub BtnDelete_Click(sender As Object, e As EventArgs) Handles BtnDelete.Click
        If DgvData.SelectedRows.Count = 1 Then
            Try
                Cursor = Cursors.WaitCursor
                _Interface.Load(DgvData.SelectedRows(0).Cells("id").Value, False)
                If Not _Interface.LockInfo.IsLocked Then
                    ...
                    End If
                Else
                    CMessageBox.Show(String.Format("Esse registro não pode ser excluído no momento pois está sendo utilizado por {0}.", _Interface.LockInfo.LockedBy.Value.Username.ToTitle()), CMessageBoxType.Information)
                End If
            Catch ex As Exception
