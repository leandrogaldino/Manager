...
Partial Class UcCompressorUnitGrid
    ...
    Private Sub InitializeComponent()
        ...
        Me.DgvlCompressorUnit = New Manager.DataGridViewLayout()
        ...
        'DgvlCompressorUnit
        '
        Me.DgvlCompressorUnit.DataGridView = Me.DgvData
        Me.DgvlCompressorUnit.Routine = Manager.Routine.CompressorUnit
        '
        'UcCompressorUnitGrid
        '
    ...
    Friend WithEvents DgvlCompressorUnit As DataGridViewLayout
End Class
