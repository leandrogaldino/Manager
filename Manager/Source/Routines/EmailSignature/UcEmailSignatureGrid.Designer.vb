...
Partial Class UcEmailSignatureGrid
    ...
    Private Sub InitializeComponent()
        ...
        Me.DgvlEmailSignature = New Manager.DataGridViewLayout()
        ...
        'DgvlEmailSignature
        '
        Me.DgvlEmailSignature.DataGridView = Me.DgvData
        Me.DgvlEmailSignature.Routine = Manager.Routine.EmailSignature
        '
        'UcEmailSignatureGrid
        '
    ...
    Friend WithEvents DgvlEmailSignature As DataGridViewLayout
End Class
