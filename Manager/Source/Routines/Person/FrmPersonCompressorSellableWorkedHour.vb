...
Public Class FrmPersonCompressorSellableWorkedHour
    ...
    Private Sub BtnLog_Click(sender As Object, e As EventArgs) Handles BtnLog.Click
        Using Form As New FrmLog(Routine.PersonCompressorSellable, _WorkedHourSellable.ID)
            Form.ShowDialog()
        End Using
    End Sub
    ...
    Private Function PreSave() As Boolean
        ...
        If IsValidFields() Then
            ...
            Dim Table = CType(_PersonCompressorForm.DgvWorkedHourSellable.DataSource, DataTable)
