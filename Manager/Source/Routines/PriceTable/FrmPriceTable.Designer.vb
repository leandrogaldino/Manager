...
Partial Class FrmPriceTable
    ...
    Private Sub InitializeComponent()
        ...
        Me.DgvlPriceTableSellable = New Manager.DataGridViewLayout()
        ...
        '
        'DgvlPriceTableSellable
        '
        Me.DgvlPriceTableSellable.DataGridView = Me.DgvPriceTableSellable
        Me.DgvlPriceTableSellable.Routine = Manager.Routine.PriceTableSellable
        '
        'FrmPriceTable
        '
    ...
    Friend WithEvents DgvlPriceTableSellable As DataGridViewLayout
