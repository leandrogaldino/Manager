...
Partial Class UcPrivilegePresetGrid
    ...
    Private Sub InitializeComponent()
        ...
        Me.DgvlPrivilegePreset = New Manager.DataGridViewLayout()
        ...
        'DgvlPrivilegePreset
        '
        Me.DgvlPrivilegePreset.DataGridView = Me.DgvData
        Me.DgvlPrivilegePreset.Routine = Manager.Routine.PrivilegePreset
        '
        'UcPrivilegePresetGrid
        '
    ...
    Friend WithEvents DgvlPrivilegePreset As DataGridViewLayout
End Class
