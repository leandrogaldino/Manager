...
Partial Class UcProductFamilyGrid
    ...
    Private Sub InitializeComponent()
        ...
        Me.DgvlProductFamily = New Manager.DataGridViewLayout()
        ...
        'DgvlProductFamily
        '
        Me.DgvlProductFamily.DataGridView = Me.DgvData
        Me.DgvlProductFamily.Routine = Manager.Routine.ProductFamily
        '
        'UcProductFamilyGrid
        '
    ...
    Friend WithEvents DgvlProductFamily As DataGridViewLayout
End Class
