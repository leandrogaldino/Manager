...
Public Class FrmRequestImportBalance
    ...
    Private Async Function FillRequestsProductsDataGridView() As Task
        ...
        Try
            ...
            Dim Sql As String = My.Resources.RequestSelectPendingItems.Replace("@inclause", InClause)
            Dim Result As LocalDB.QueryResult = Await _LocalDB.ExecuteRawQueryAsync(Sql, Params)
        ...
        Catch ex As Exception
            CMessageBox.Show("ERRO RQ012", "Erro ao importar.", CMessageBoxType.Error, CMessageBoxButtons.OK, ex)
        End Try
    End Function
