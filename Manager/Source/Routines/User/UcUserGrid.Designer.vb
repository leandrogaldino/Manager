...
Partial Class UcUserGrid
    ...
    Private Sub InitializeComponent()
        ...
        Me.DgvlUser = New Manager.DataGridViewLayout()
        ...
        'DgvlUser
        '
        Me.DgvlUser.DataGridView = Me.DgvData
        Me.DgvlUser.Routine = Manager.Routine.User
        '
        'UcUserGrid
        '
    ...
    Friend WithEvents DgvlUser As DataGridViewLayout
End Class
