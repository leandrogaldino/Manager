...
Public Class UcVisitScheduleGrid
    ...
    Private Sub Me_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DgvlVisitSchedule.Load()
    End Sub
    Private Sub BtnInclude_Click(sender As Object, e As EventArgs) Handles BtnInclude.Click
        Using Form As New FrmVisitSchedule(New VisitSchedule, Me)
            Form.ShowDialog()
        End Using
    End Sub
    Private Sub BtnEdit_Click(sender As Object, e As EventArgs) Handles BtnEdit.Click
        If DgvData.SelectedRows.Count = 1 Then
            Try
                ...
                Using Form As New FrmVisitSchedule(_VisitSchedule, Me)
                    Form.ShowDialog()
                End Using
    ...
    Private Sub BtnDelete_Click(sender As Object, e As EventArgs) Handles BtnDelete.Click
        If DgvData.SelectedRows.Count = 1 Then
            Try
                ...
                End If
            Catch ex As Exception
                CMessageBox.Show("ERRO VS003", "Ocorreu um erro ao excluir o registro.", CMessageBoxType.Error, CMessageBoxButtons.OK, ex)
            Finally
                Cursor = Cursors.Default
            End Try
        End If
