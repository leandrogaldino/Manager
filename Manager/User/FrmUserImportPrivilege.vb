...
Public Class FrmUserImportPrivilege
    ...
    Private Sub QbxPreset_Enter(sender As Object, e As EventArgs) Handles QbxPreset.Enter
        TmrQueriedBox.Stop()
        BtnView.Visible = QbxPreset.IsFreezed And Locator.GetInstance(Of Session).User.Privilege.UserPrivilegePresetWrite
        BtnNew.Visible = Locator.GetInstance(Of Session).User.Privilege.UserPrivilegePresetWrite
        BtnFilter.Visible = Locator.GetInstance(Of Session).User.Privilege.UserPrivilegePresetAccess
    End Sub
