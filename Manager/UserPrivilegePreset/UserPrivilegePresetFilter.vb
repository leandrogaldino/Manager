...
''' <summary>
''' Representa o filtro da predefinição de permissões do usuário.
''' </summary>
Public Class UserPrivilegePresetFilter
    <Browsable(False)>
    ...
    Public Overridable Function Filter() As Boolean
        ...
        Using Con As New MySqlConnection(Locator.GetInstance(Of Session).Setting.Database.GetConnectionString())
            Con.Open()
            Using Cmd As New MySqlCommand(My.Resources.UserPrivilegePresetFilter, Con)
