...
Public Class SetupLocator
    Public Shared Sub Setup()
        ...
        Locator.RegisterSingleton(Of LocalDB)(New ManagerCore.MySqlService())
        ...
        Locator.RegisterSingleton(Of TaskBase)(New TaskClean(Locator.GetInstance(Of LocalDB), Locator.GetInstance(Of RemoteDB)(CloudDatabaseType.Customer), Locator.GetInstance(Of SettingService), Locator.GetInstance(Of SessionModel)), TaskName.Clean)
        Locator.RegisterSingleton(Of TaskBase)(New TaskCleanManual(Locator.GetInstance(Of LocalDB), Locator.GetInstance(Of RemoteDB)(CloudDatabaseType.Customer), Locator.GetInstance(Of SettingService), Locator.GetInstance(Of SessionModel)), TaskName.CleanManual)
