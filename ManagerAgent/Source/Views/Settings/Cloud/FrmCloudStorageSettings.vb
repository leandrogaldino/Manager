...
Public Class FrmCloudStorageSettings
    Private _ViewModel As CloudStorageSettingsViewModel

    Public Sub New()
        InitializeComponent()
        _ViewModel = New CloudStorageSettingsViewModel()
        InitializeBindings()
    ...
    Private Sub InitializeBindings()
        TxtName.DataBindings.Add("Text", _ViewModel, "BucketName", False, DataSourceUpdateMode.OnPropertyChanged)
