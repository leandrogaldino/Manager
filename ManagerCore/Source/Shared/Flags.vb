...
Public Enum LicenseMessages
        ...
        <Description("Não conseguimos encontrar o arquivo da licença do produto. Por favor, inicie o ManagerAgent para solucionar o problema.")> LicenseFileNotFound = 2
